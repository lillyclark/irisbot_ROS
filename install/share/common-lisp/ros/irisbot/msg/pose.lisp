...
(cl:defmethod cl:initialize-instance :after ((m <pose>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'pose)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name irisbot-msg:<pose> is deprecated: use irisbot-msg:pose instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <pose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader irisbot-msg:x-val is deprecated.  Use irisbot-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <pose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader irisbot-msg:y-val is deprecated.  Use irisbot-msg:y instead.")
  (y m))
