...
(cl:defmethod cl:initialize-instance :after ((m <Person>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Person)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lillypkg-msg:<Person> is deprecated: use lillypkg-msg:Person instead.")))

(cl:ensure-generic-function 'first_name-val :lambda-list '(m))
(cl:defmethod first_name-val ((m <Person>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lillypkg-msg:first_name-val is deprecated.  Use lillypkg-msg:first_name instead.")
  (first_name m))

(cl:ensure-generic-function 'last_name-val :lambda-list '(m))
(cl:defmethod last_name-val ((m <Person>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lillypkg-msg:last_name-val is deprecated.  Use lillypkg-msg:last_name instead.")
  (last_name m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Person>)))
  ...
  "7eae61f42fe10628000d2b10fec2f3bd")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Person)))
  "Returns md5sum for a message object of type 'Person"
  "7eae61f42fe10628000d2b10fec2f3bd")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Person>)))
  ...
  (cl:format cl:nil "string first_name~%string last_name~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Person)))
  "Returns full string definition for message of type 'Person"
  (cl:format cl:nil "string first_name~%string last_name~%~%~%"))
